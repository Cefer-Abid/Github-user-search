...
export const toggleDarkMode = function (isDarkMode) {
  if (isDarkMode) {
...
export const displayUserProfil = function (data, joinDate) {
 ...
 <div class="user__div">
  ...
  <div class="user__address-div">
    ...
    class=${data.location ? "address-icon--active" : "address-icon--passive"}
    ...
    <div class="user--address">
      <svg height="18" width="20" xmlns="http://www.w3.org/2000/svg"><path fill="#4b6a9b" class=${
        data.twitter_username ? "address-icon--active" : "address-icon--passive"
    ...
    <svg height="20" width="20" xmlns="http://www.w3.org/2000/svg"><g fill="#4b6a9b"
       class=${data.blog ? "address-icon--active" : "address-icon--passive"}>
    ...
    <div class="user--address">
    <svg height="20" width="20" xmlns="http://www.w3.org/2000/svg"><g fill="#4b6a9b"
     class=${data.company ? "address-icon--active" : "address-icon--passive"}> 
      ...
      <span class="address-text ${data.company || "address-text__passive"}">
